...
function handleRoute() {
    ...
    if (currentlyLoggedUser === "" && hash !== "") {
        ...
        headerVisitor.innerHTML =
            `<header class="d-flex justify-content-between align-items-start py-2">
        ...
        headerArtist.innerHTML =
            `<header class="d-flex justify-content-between align-items-start py-2">
                ...
                <i class="fa-solid fa-bars hamburgerIcon navbar-toggler navbar-toggler-icon"
                data-toggle="collapse" data-target="#hambMenu"></i>
            </header>
